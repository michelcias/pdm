...
#'   `binomial_localacceleration`. This function is called by
...
#'   \itemize{
#'     \item `binomial_localacceleration`: Specific model class
...
#'   `binomial_localacceleration`. Checks that all required components are present
...
#'
#' @description Test whether an object is of class `binomial_localacceleration`.
#'
...
#'
#' @param x An object of class `binomial_localacceleration`.
