...
#'   \code{binomial_locallevel}. This function is called by
...
#'   \code{binomial_locallevel}. Checks that all required components are present
...
#'
#' @description Test whether an object is of class \code{binomial_locallevel}.
#'
