...
#'   \code{normal_localtrend}. This function is called by
...
#'
#' @return An object of class \code{c("normal_localtrend", "bdm_mcmc", "list")}
...
#'   \itemize{
#'     \item \code{normal_localtrend}: Specific model class
...
new_normal_localtrend <- function(result,
  ...
  # Add class hierarchy
  class(result) <- c("normal_localtrend", "bdm_mcmc", "list")
...
#'   \code{normal_localtrend}. Checks that all required components are present
...
#'
#' @description Test whether an object is of class \code{normal_localtrend}.
#'
