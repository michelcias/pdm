...
#'   \code{poisson_localacceleration}. This function is called by
...
#'
#' @return An object of class \code{c("poisson_localacceleration", "bdm_mcmc", "list")}
...
#'   \itemize{
#'     \item \code{poisson_localacceleration}:  Specific model class
...
new_poisson_localacceleration <- function(result,
  ...
  # Add class hierarchy
  class(result) <- c("poisson_localacceleration", "bdm_mcmc", "list")
...
#'   \code{poisson_localacceleration}.  Checks that all required components are present
...
#'
#' @description Test whether an object is of class \code{poisson_localacceleration}.
#'
