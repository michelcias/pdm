#' Constructor for poisson_locallevel class
#'
#' @description Internal constructor function for creating objects of class
#'   `poisson_locallevel`. This function is called by
...
#'   \itemize{
#'     \item `poisson_locallevel`:  Specific model class
...
#' @keywords internal
#' @noRd
new_poisson_locallevel <- function(result,
                                   n_obs,
                                   n_draws,
                                   burnin,
                                   thinning,
...
#' Validator for poisson_locallevel class
#'
#' @description Internal function to validate objects of class
#'   `poisson_locallevel`.  Checks that all required components are present
...
#' @keywords internal
#' @noRd
validate_poisson_locallevel <- function(x) {

  # 1. Check class
  if (!inherits(x, "poisson_locallevel")) {
    stop("Object must inherit from class 'poisson_locallevel'")
  }
...
#'
#' @description Test whether an object is of class `poisson_locallevel`.
#'
...
print.poisson_locallevel <- function(x, digits = 3, ...) {
  ...
  # Validate input
  if (!inherits(x, "poisson_locallevel")) {
    stop("Object must be of class 'poisson_locallevel'")
  }
  ...
  cat("\n")
  cat("Poisson Local-Level Model (Log Link)\n")
  cat(strrep("=", 70), "\n\n", sep = "")
