...
#'   `probit_bernoulli_localacceleration`. This function is called by
...
#'
#' @return An object of class `c("probit_bernoulli_localacceleration", "pdm_mcmc", "list")`
...
#'   \itemize{
#'     \item `probit_bernoulli_localacceleration`: Specific model class
...
#'   `probit_bernoulli_localacceleration`. Checks that all required components
...
#'
#' @description Test whether an object is of class `probit_bernoulli_localacceleration`.
#'
