...
#'
#' @return An object of class \code{c("probit_bernoulli_locallevel", "bdm_mcmc", "list")}
...
#' @keywords internal
#' @noRd
new_probit_bernoulli_locallevel <- function(result,
                                            n_obs,
                                            n_chain,
                                            burnin,
                                            thinning,
  ...
  # Add class hierarchy
  class(result) <- c("probit_bernoulli_locallevel", "bdm_mcmc", "list")
...
validate_probit_bernoulli_locallevel <- function(x) {
  ...
  # 1. Check class
  if (!inherits(x, "probit_bernoulli_locallevel")) {
    stop("Object must inherit from class 'probit_bernoulli_locallevel'")
  }
...
#' )
#'
#' is.probit_bernoulli_locallevel(out)  # TRUE
#' is.probit_bernoulli_locallevel(list())  # FALSE
#' }
#'
#' @export
is.probit_bernoulli_locallevel <- function(x) {
  inherits(x, "probit_bernoulli_locallevel")
}
...
print.probit_bernoulli_locallevel <- function(x, digits = 3, ...) {
  ...
  # Validate input
  if (!inherits(x, "probit_bernoulli_locallevel")) {
    stop("Object must be of class 'probit_bernoulli_locallevel'")
  }
  ...
  cat("\n")
  cat("Bernoulli Local-Level Model (Probit Link)\n")
  cat(strrep("=", 70), "\n\n", sep = "")
