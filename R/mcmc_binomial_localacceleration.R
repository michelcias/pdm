...
#'   \item{\code{alpha}}{Numeric matrix \eqn{[n_{draws} \times n]} of posterior samples for \eqn{\alpha_t}. Convergence of \eqn{\alpha_t} is already covered by the
...
#'
#' @seealso
#'   \code{\link{plot.binomial_localacceleration}},
#'   \code{\link{print.binomial_localacceleration}},
#'   \code{\link{summary.binomial_localacceleration}} for methods on the fitted object;
#'   \code{\link{mcmc_binomial_locallevel}} and
#'   \code{\link{mcmc_binomial_localtrend}} for the other dynamic orders.
#'
#' @export
