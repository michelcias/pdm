...
#'     samples for the time-varying mixture weights \eqn{\alpha_t = P(z_t = 1)}. Convergence of \eqn{\alpha_t} is already covered by the
...
#'   plot(out_logit, type = "mcmc", which = 5:10)  # Dynamic-state params
...
#'   \code{\link{summary.normal_mixture_localacceleration}} for methods on the fitted object;
#'   \code{\link{mcmc_normal_mixture_locallevel}} and
#'   \code{\link{mcmc_normal_mixture_localtrend}} for the other dynamic orders.
#'
#' @export
