...
#'   \link[bdm]{mcmc_normal_localacceleration}
#' @export
mcmc_poisson_localacceleration <- function(y,
  ...
  # Call the C function
  result <- .Call(
    "_bdm_C_MCMC_log_poisson_localacceleration",
    as.numeric(y),
    as.integer(burnin),
    as.integer(thinning),
    as.integer(n_chain),
