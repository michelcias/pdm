...
#'
#' # Generate true rates with trend (ensuring positive values)
...
#' out_hc <- mcmc_poisson_localtrend(
#'   y,
#'   burnin             = 1000,
#'   thinning           = 20,
#'   n_draws            = 500,
...
#'   plot(out, type = "mcmc", which = 1:2)    # Parameter diagnostics
...
#'
#' @seealso
#'   \code{\link{plot.poisson_localtrend}},
#'   \code{\link{print.poisson_localtrend}},
#'   \code{\link{summary.poisson_localtrend}} for methods on the fitted object;
...
mcmc_poisson_localtrend <- function(y,
  ...
  result <- validate_poisson_localtrend(result)
