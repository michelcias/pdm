...
#'   you can obtain `theta_1` using `qlogis(alpha)`.
#'
...
#'     value specified in `mcmc_binomial_locallevel`)
...
#' proportion that was specified when running `mcmc_binomial_locallevel`.
