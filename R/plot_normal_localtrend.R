...
#'   the component names returned by \code{\link{mcmc_normal_localtrend}}.
#'
#'   Accepted elements:
#'   \describe{
...
#' theta01_true     <- 10       # True initial level
...
#' # mcmc_normal_localtrend() - see ?mcmc_normal_localtrend
#' true_vals <- list(
...
#' plot(out, type = "mcmc", which = 2:3, true_values = true_vals)
#'
#' # 5. Focus on innovation precisions with true values
#' plot(out, type = "mcmc", which = 4:5, true_values = true_vals)
#'
...
#' plot(out, type = "mcmc", which = 4:5, true_values = list(
#'   prec_theta1 = prec_theta1_true,
#'   prec_theta2 = prec_theta2_true
#' ))
#'
...
#'
#' #    Example 4: Only trend trajectory
#' plot(out, type = "states",
