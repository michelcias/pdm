...
#'   \item Page 17: Acceptance proportions (only if available)
#' }
#'
...
#'
#' # 1. Complete diagnostic dashboard (17 pages)
...
#' prec_theta3_true <- 10000   # True acceleration precision (nearly constant)
#'
...
#' out <- mcmc_normal_mixture_localacceleration(
#'   y,
#'   link               = "logit",
#'   burnin             = 50000,
#'   thinning           = 500,
...
#' # mcmc_normal_mixture_localacceleration() - see ?mcmc_normal_mixture_localacceleration
#' true_vals <- list(
...
#' plot(out, type = "mcmc", which = 5:10, true_values = true_vals)
#'
...
#' plot(out, type = "mcmc", which = 8:10, true_values = list(
#'   prec_theta1 = prec_theta1_true,
#'   prec_theta2 = prec_theta2_true,
#'   prec_theta3 = prec_theta3_true
#' ))
...
#'
#' #    Example 5: Only trend and acceleration trajectories
