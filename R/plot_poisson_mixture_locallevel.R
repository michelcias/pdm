#' Plot method for poisson_mixture_locallevel objects
#'
...
#'   are `lambda_1`, `lambda_2`, `theta_01`, `prec_theta1`, `theta_1`, `alpha`
#'   and `z`. If `NULL` (default), no true values are displayed.
...
#' plot(out_logit, type = "mcmc", which = 1:4)    # Scalar-parameter diagnostics
...
#'   \code{\link{print.poisson_mixture_locallevel}}, \code{\link{summary.poisson_mixture_locallevel}}.
#'
#' @export
plot.poisson_mixture_locallevel <- function(x,
  ...
  plot_poisson_mixture_dispatch(
    ...
    generator = "mcmc_poisson_mixture_locallevel", ...
  )
}
