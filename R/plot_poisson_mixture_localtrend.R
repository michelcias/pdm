#' Plot method for poisson_mixture_localtrend objects
#'
...
#'     \item{\code{"states"}}{Dynamic states (theta_1 and theta_2 trajectories)}
...
#'   are `lambda_1`, `lambda_2`, `theta_01`, `theta_02`, `prec_theta1`,
#'   `prec_theta2`, `theta_1`, `theta_2`, `alpha` and `z`. If `NULL` (default),
#'   no true values are displayed.
...
#' plot(out_logit, type = "mcmc", which = 1:6)    # Scalar-parameter diagnostics
...
#'   \code{\link{print.poisson_mixture_localtrend}}, \code{\link{summary.poisson_mixture_localtrend}}.
#'
#' @export
plot.poisson_mixture_localtrend <- function(x,
  ...
  plot_poisson_mixture_dispatch(
    ...
    generator = "mcmc_poisson_mixture_localtrend", ...
  )
}
