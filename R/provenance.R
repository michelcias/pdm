...
#' Attaches three things a saved object could not otherwise report: the package
#' version, the seed, and every prior actually used.
#'
...
#'
#' @return `object`, with `pdm_version`, `seed` and `priors` attached.
#'
#' @keywords internal
#' @noRd
record_provenance <- function(object, seed, env = parent.frame()) {
