...
#'
#' @param object An object of class `binomial_localacceleration`, typically
...
#'
#' @return An object of class `summary.binomial_localacceleration`, which is
#'   a list containing:
#'   \describe{
...
#'
#' @param x An object of class `summary.binomial_localacceleration`, typically
#'   the result of calling `summary()` on a `binomial_localacceleration`
#'   object.
