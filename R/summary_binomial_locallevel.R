...
#'
#' @param object An object of class \code{binomial_locallevel}, typically
...
#'
#' @return An object of class \code{summary.binomial_locallevel}, which is
#'   a list containing:
#'   \describe{
...
#'
#' @param x An object of class \code{summary.binomial_locallevel}, typically
#'   the result of calling \code{summary()} on a \code{binomial_locallevel}
#'   object.
