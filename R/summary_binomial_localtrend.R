...
#'
#' @param object An object of class \code{binomial_localtrend}, typically
...
#'
#' @return An object of class \code{summary.binomial_localtrend}, which is
#'   a list containing:
#'   \describe{
...
summary.binomial_localtrend <- function(object,
  ...
  # Validate input
  validate_summary_input(object, probs, "binomial_localtrend")
...
#'
#' @param x An object of class \code{summary.binomial_localtrend}, typically
#'   the result of calling \code{summary()} on a \code{binomial_localtrend}
#'   object.
