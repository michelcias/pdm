...
#'
#' @param object An object of class `normal_localacceleration`, typically the
...
#'
#' @return An object of class `summary.normal_localacceleration`, which is a list
#'   containing:
#'   \describe{
...
#' `plot()` to visualize the full trajectories.
#'
#' @examples
#' \donttest{
#' ## Simulation of data
...
summary.normal_localacceleration <- function(object,
  ...
  # Validate input
  validate_summary_input(object, ci_level, "normal_localacceleration")
...
#'
#' @param x An object of class `summary.normal_localacceleration`, typically the
#'   result of calling `summary()` on a `normal_localacceleration` object.
