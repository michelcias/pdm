...
#'
#' @param object An object of class `normal_mixture_localacceleration`, typically
...
#'
#' @return An object of class `summary.normal_mixture_localacceleration`, which is
#'   a list containing:
#'   \describe{
...
#'
#' @param x An object of class `summary.normal_mixture_localacceleration`, typically
#'   the result of calling `summary()` on a `normal_mixture_localacceleration`
#'   object.
