...
#'
#' @param object An object of class `normal_mixture_locallevel`, typically
...
#'
#' @return An object of class `summary.normal_mixture_locallevel`, which is
#'   a list containing:
#'   \describe{
...
summary.normal_mixture_locallevel <- function(object,
  ...
  # Validate input
  validate_summary_input(object, ci_level, "normal_mixture_locallevel")
  ...
  state_params <- format_state_params(object, ci_level, order = "level")
...
#'
#' @param x An object of class `summary.normal_mixture_locallevel`, typically
#'   the result of calling `summary()` on a `normal_mixture_locallevel`
#'   object.
