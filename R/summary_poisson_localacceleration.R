...
#'
#' @param object An object of class \code{poisson_localacceleration}, typically
...
#'
#' @return An object of class \code{summary.poisson_localacceleration}, which is
#'   a list containing:
#'   \describe{
...
#'
#' @param x An object of class \code{summary.poisson_localacceleration}, typically
#'   the result of calling \code{summary()} on a \code{poisson_localacceleration}
#'   object.
