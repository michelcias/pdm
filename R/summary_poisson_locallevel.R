...
#'
#' @param object An object of class `poisson_locallevel`, typically
...
#'
#' @param x An object of class `summary.poisson_locallevel`, typically
#'   the result of calling `summary()` on a `poisson_locallevel`
#'   object.
