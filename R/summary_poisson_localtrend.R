#' Summary method for poisson_localtrend objects
#'
...
summary.poisson_localtrend <- function(object,
  ...
  # Validate input
  validate_summary_input(object, ci_level, "poisson_localtrend")
  ...
  class(result) <- "summary.poisson_localtrend"
  return(result)
}


#' Print method for summary.poisson_localtrend objects
#'
...
#' }
#'
#' @seealso \code{\link{summary.poisson_localtrend}},
