#' Summary method for poisson_mixture_localacceleration objects
#'
...
#'
#' @param object An object of class `poisson_mixture_localacceleration`,
#'   typically the result of calling
#'   \code{\link{mcmc_poisson_mixture_localacceleration}}.
...
#'
#' @return An object of class `summary.poisson_mixture_localacceleration`, which
...
#'       dynamic state parameters (theta_01 to theta_03, W_1^-1 to W_3^-1)}
...
#'
#' @export
summary.poisson_mixture_localacceleration <- function(object,
                                                      ci_level = 0.95,
                                                      ...) {

  summary_poisson_mixture(object, ci_level,
                          cls   = "poisson_mixture_localacceleration",
                          order = "acceleration")
}


#' Print method for summary.poisson_mixture_localacceleration objects
#'
#' @description Prints comprehensive posterior statistics in a readable format.
#'
#' @param x An object of class `summary.poisson_mixture_localacceleration`,
#'   typically the result of calling `summary()` on a
#'   `poisson_mixture_localacceleration` object.
...
#'
#' @export
print.summary.poisson_mixture_localacceleration <- function(x, digits = 3, ...) {
