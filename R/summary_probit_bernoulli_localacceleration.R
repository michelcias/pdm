...
#'
#' @param object An object of class `probit_bernoulli_localacceleration`, typically
...
#'
#' @return An object of class `summary.probit_bernoulli_localacceleration`, which is
#'   a list containing:
#'   \describe{
...
#'     \item{`alpha_summary`}{Summary statistics for the Bernoulli
...
summary.probit_bernoulli_localacceleration <- function(object,
  ...
  # Validate input
  validate_summary_input(object, ci_level, "probit_bernoulli_localacceleration")
...
#'
#' @param x An object of class `summary.probit_bernoulli_localacceleration`, typically
#'   the result of calling `summary()` on a `probit_bernoulli_localacceleration`
#'   object.
