...
#'
#' @param object An object of class \code{probit_bernoulli_locallevel}, typically
...
#'
#' @return An object of class \code{summary.probit_bernoulli_locallevel}, which is
#'   a list containing:
#'   \describe{
...
summary.probit_bernoulli_locallevel <- function(object,
  ...
  # Validate input
  validate_summary_input(object, probs, "probit_bernoulli_locallevel")
...
#'
#' @param x An object of class \code{summary.probit_bernoulli_locallevel}, typically
#'   the result of calling \code{summary()} on a \code{probit_bernoulli_locallevel}
#'   object.
