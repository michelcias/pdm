...
#'
#' @param object An object of class \code{probit_bernoulli_localtrend}, typically
...
#'
#' @return An object of class \code{summary.probit_bernoulli_localtrend}, which is
#'   a list containing:
#'   \describe{
...
summary.probit_bernoulli_localtrend <- function(object,
  ...
  # Validate input
  validate_summary_input(object, probs, "probit_bernoulli_localtrend")
...
#'
#' @param x An object of class \code{summary.probit_bernoulli_localtrend}, typically
#'   the result of calling \code{summary()} on a \code{probit_bernoulli_localtrend}
#'   object.
