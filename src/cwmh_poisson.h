/**
 * @file cwmh_poisson.h
 * @brief Header for component-wise Metropolis-Hastings sampling in log-Poisson state-space models
 * @author Michel H. Montoril
 * @date 2025-12-20
 * @version 1.0
 *
 * @details This header declares optimized functions for component-wise Metropolis-Hastings (CWMH)
 *          sampling in Poisson dynamic models with log link.  All functions utilize
 *          memory-efficient current/previous iteration buffers and incorporate adaptive
 *          proposal tuning mechanisms.
 *
 *          **Key features:**
 *          - Component-wise MH for local level Poisson models
 *          - Component-wise MH for local trend Poisson models
 ...
 *          in Poisson state-space models with log link:
...
#ifndef CWMH_POISSON_H
#define CWMH_POISSON_H
