...
SEXP C_MCMC_localtrend(SEXP y_, SEXP burnin_, SEXP thinning_, SEXP n_chain_,
    ...
    for (int ii = 1; ii < n_iter; ii++) {
        ...
        generate_theta_p(
            theta_01_post, theta_02_post, theta_2_post, prec_2_post,
            theta_1_post, prec_1_post, n, ii
        );
        ...
        generate_theta_0p(
            theta_01_post, theta_02_post, theta_1_post, theta_2_post,
            prec_1_post, prec_2_post, theta_02_post,
            theta02_mean, theta02_prec, n, ii
        );

        /* 4) Sample level state vector theta_1 */
        generate_theta_1(
            y, theta_1_post, theta_2_post, prec_y_post, prec_1_post,
            theta_01_post, theta_02_post, n, ii
        );

        /* 5) Sample innovation precision 1/W_1 */
        generate_precision_theta_k(
            theta_01_post, theta_02_post, theta_1_post, theta_2_post,
            prec_1_post, nu_01, eta_01, n, ii
        );

        /* 6) Sample initial level state theta_01 */
        generate_theta_01(
            theta_02_post, theta_1_post, prec_1_post, theta_01_post, n, ii
        );
