/**
 * @file mcmc_localtrend.h
 * @brief MCMC implementation for local-trend dynamic models
 * @details This module provides Gibbs sampling functionality for polynomial dynamic models
 *          with local-trend structure (p=2), implementing Bayesian estimation through
 *          conditional posterior distributions for level and trend components.
