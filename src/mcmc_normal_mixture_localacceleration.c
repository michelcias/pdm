...
SEXP C_MCMC_normal_mixture_localacceleration(SEXP y_,
  ...
  double aux_W1, aux_W2, aux_W3, aux_phi1, aux_phi2;
  ...
  theta_03_previous    = init[4];
  params_previous[1]   = init[5];   /* phi_1 */
  params_previous[3]   = init[6];   /* phi_2 */
  prec_theta1_previous = init[7];
  prec_theta2_previous = init[8];
  prec_theta3_previous = init[9];
  aux_phi1             = init[10];
  aux_phi2             = init[11];
  aux_W1               = init[12];
  aux_W2               = init[13];
