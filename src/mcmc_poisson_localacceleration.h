 ...
 *
 *          **Model specification:**
 *          Local-acceleration state equations:
...
#ifndef MCMC_POISSON_LOCALACCELERATION_H
#define MCMC_POISSON_LOCALACCELERATION_H
...
#endif /* MCMC_POISSON_LOCALACCELERATION_H */