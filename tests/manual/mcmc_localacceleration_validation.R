...
#     * _pdm_test_generate_theta_p / _theta_k         (state updates for theta_3/theta_2)
#     * _pdm_test_generate_precision_theta_p / _theta_k (precision updates)
#     * _pdm_test_generate_theta_0p / _theta_0k       (initial state updates)
